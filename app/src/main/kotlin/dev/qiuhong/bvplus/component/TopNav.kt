...
import dev.qiuhong.bvplus.activities.settings.SettingsActivity
import dev.qiuhong.bvplus.activities.user.LoginActivity
...
fun TopNav(
    ...
    var selectedNav by remember { mutableStateOf(TopNavItem.Rcmd) }
    val navList =
        listOf(TopNavItem.Search, TopNavItem.Rcmd, TopNavItem.Popular, TopNavItem.Anime, TopNavItem.Dynamics)
...
fun NavItemTab(
    ...
    val tabModifier =
        ...
        if (topNavItem == TopNavItem.Rcmd || selected)
...
enum class TopNavItem(private val _displayNameResId: Int) {
    ...
    Rcmd(R.string.top_nav_item_rcmd),

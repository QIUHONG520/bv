...
import dev.qiuhong.biliapi.entity.BiliResponse
import dev.qiuhong.biliapi.entity.BiliResponseWithoutData
import dev.qiuhong.biliapi.entity.anime.AnimeFeedData
import dev.qiuhong.biliapi.entity.anime.AnimeHomepageData
import dev.qiuhong.biliapi.entity.anime.AnimeHomepageDataType
import dev.qiuhong.biliapi.entity.anime.AnimeHomepageDataV1
import dev.qiuhong.biliapi.entity.anime.AnimeHomepageDataV2
import dev.qiuhong.biliapi.entity.danmaku.DanmakuData
import dev.qiuhong.biliapi.entity.danmaku.DanmakuResponse
import dev.qiuhong.biliapi.entity.dynamic.DynamicData
import dev.qiuhong.biliapi.entity.history.HistoryData
import dev.qiuhong.biliapi.entity.search.HotwordData
import dev.qiuhong.biliapi.entity.search.KeywordSuggest
import dev.qiuhong.biliapi.entity.search.SearchResultData
import dev.qiuhong.biliapi.entity.season.FollowingSeasonData
...
import dev.qiuhong.biliapi.entity.season.SeasonData
import dev.qiuhong.biliapi.entity.season.SeasonFollowData
import dev.qiuhong.biliapi.entity.user.FollowAction
import dev.qiuhong.biliapi.entity.user.FollowActionSource
import dev.qiuhong.biliapi.entity.user.MyInfoData
import dev.qiuhong.biliapi.entity.user.RelationData
import dev.qiuhong.biliapi.entity.user.RelationStat
import dev.qiuhong.biliapi.entity.user.SpaceVideoData
import dev.qiuhong.biliapi.entity.user.UserCardData
import dev.qiuhong.biliapi.entity.user.UserFollowData
import dev.qiuhong.biliapi.entity.user.UserInfoData
import dev.qiuhong.biliapi.entity.user.favorite.FavoriteFolderInfo
import dev.qiuhong.biliapi.entity.user.favorite.FavoriteFolderInfoListData
import dev.qiuhong.biliapi.entity.user.favorite.FavoriteItemIdListResponse
import dev.qiuhong.biliapi.entity.user.favorite.UserFavoriteFoldersData
import dev.qiuhong.biliapi.entity.video.AddCoin
import dev.qiuhong.biliapi.entity.video.CheckSentCoin
import dev.qiuhong.biliapi.entity.video.CheckVideoFavoured
import dev.qiuhong.biliapi.entity.video.PlayUrlData
import dev.qiuhong.biliapi.entity.video.PopularVideoData
import dev.qiuhong.biliapi.entity.video.RcmdVideoData
import dev.qiuhong.biliapi.entity.video.RelatedVideosResponse
import dev.qiuhong.biliapi.entity.video.SetVideoFavorite
import dev.qiuhong.biliapi.entity.video.Tag
import dev.qiuhong.biliapi.entity.video.TagDetail
import dev.qiuhong.biliapi.entity.video.TagTopVideosResponse
import dev.qiuhong.biliapi.entity.video.Timeline
import dev.qiuhong.biliapi.entity.video.TimelineType
import dev.qiuhong.biliapi.entity.video.VideoInfo
import dev.qiuhong.biliapi.entity.video.VideoMoreInfo
...
object BiliApi {
     ...
     * 获取推荐视频列表
     */
    suspend fun getRcmdVideoData(
        fresh_idx: Int = 1,
        pageSize: Int = 20,
        feed_version: String = "V1",
        fresh_type: Int = 1,
        plat: Int = 1,
        sessData: String = ""
    ): BiliResponse<RcmdVideoData> = client.get("/x/web-interface/index/top/feed/rcmd") {
        parameter("fresh_idx", fresh_idx)
        parameter("ps", pageSize)
        parameter("feed_version", feed_version)
        parameter("fresh_type", fresh_type)
        parameter("plat", plat)
